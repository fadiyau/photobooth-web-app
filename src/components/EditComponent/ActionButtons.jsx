        ...
        {isDropdownOpen && (
          <div className="absolute right-0 bottom-full mb-2 w-48 sm:w-52 bg-white rounded-xl sm:rounded-2xl shadow-xl border border-gray-100 py-1.5 z-50 animate-in fade-in slide-in-from-bottom-2 duration-150">
            ...
            <button
              ...
              onClick={() => {
                setIsDropdownOpen(false);
                onDownload('video/mp4');
              }}
              className="w-full px-3.5 py-2 text-left text-xs font-semibold text-gray-700 hover:bg-rose-50 hover:text-rose-600 flex items-center justify-between cursor-pointer transition-colors border-t border-gray-100"
            >
              <div className="flex items-center gap-2">
                <svg className="w-3.5 h-3.5 text-rose-500 shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
                  <polygon points="23 7 16 12 23 17 23 7" />
                  <rect x="1" y="5" width="15" height="14" rx="2" ry="2" />
                </svg>
                <span className="font-bold text-gray-800 hover:text-rose-600">MP4 (Live Photo)</span>
              </div>
              <span className="text-[9px] bg-rose-100 text-rose-600 font-extrabold px-1.5 py-0.5 rounded flex items-center gap-0.5">
