...
export default function HeroSection() {
  return (
    <section className="max-w-[1800px] mx-auto px-6 sm:px-12 lg:px-38 pt-35 pb-0 sm:py-25 2xl:py-50 md:min-h-[calc(100vh-80px)] flex items-center justify-center">
      <div className="grid grid-cols-1 md:grid-cols-12 gap-10 lg:gap-16 items-center w-full">
        
        {/* Teks Kiri (Mobile: Center, Desktop: Left) */}
